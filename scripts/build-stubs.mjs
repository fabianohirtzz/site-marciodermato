...
const NAV = (active) => `  <header class="nav nav--solid" data-nav>
    <div class="nav__inner">
      ...
      <a class="btn btn--primary nav__cta" href="${CTA}" target="_blank" rel="noopener">Agende sua consulta</a>
  ...
  <aside class="drawer" id="drawer" data-drawer aria-hidden="true">
    ...
    <a class="btn btn--primary drawer__cta" href="${CTA}" target="_blank" rel="noopener">Agende sua consulta</a>
  </aside>`;
