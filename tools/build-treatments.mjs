...
import { NAV_ITEMS, footerSocialHTML, drawerSocialHTML, footerPhoneHTML } from "./lib/chrome-parts.mjs";
...
function navHTML() {
  // Toda página de tratamento vive em tratamentos/<slug>/, então o menu sobe
  // dois níveis. A lista canônica de itens vem de lib/chrome-parts.mjs.
  const links = NAV_ITEMS.map(([h, l, k]) => [`../../${h}`, l, k === "tratamentos"]);
